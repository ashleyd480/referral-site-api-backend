package com.example.notificationmicro.config;
...
// RestTemplate is a class provided by Spring Framework that allows us to make Rest calls to other web services (in this case Spring ReferAll Main)